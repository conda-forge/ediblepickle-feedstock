...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ediblepickle-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14195&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ediblepickle-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ediblepickle` can be installed with:

```
conda install ediblepickle
```

It is possible to list all of the versions of `ediblepickle` available on your platform with:
